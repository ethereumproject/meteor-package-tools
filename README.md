...
When using this package as a Meteor package it will call the [kraken.com public API](https://api.kraken.com/0/public/Ticker?pair=XETCZEUR,XXBTZUSD) every 30s to retrive price information for ether.
