...
When using the `EthTools.ticker` it will call the [cryptocompare.com public API](https://min-api.cryptocompare.com/data/price?fsym=ETC&tsyms=BTC,USD,EUR) every 30s to retrive price information for ether.
